	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver(); //launch chrome
				...
				for(int i=4; i<=7; i++){
					...
					if(name.contains("Jhun Jhun wala")){ //i=5
				...
				*/
				//Method-2:
				driver.findElement(By.xpath("//a[contains(text(),'Jhun Jhun')]/parent::td//preceding-sibling::td//input[@name='contact_id']")).click();
				driver.findElement(By.xpath("//a[contains(text(),'Hello Mr')]/parent::td//preceding-sibling::td//input[@name='contact_id']")).click();
